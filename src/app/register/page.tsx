...
import { Sparkles, Zap, Shield, UserPlus } from 'lucide-react'
          ...
          <div className="hidden md:block space-y-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-lg text-gray-600">
                Crea tu cuenta y disfruta de delivery express con los mejores productos y precios
              </p>
            </div>
          ...
          <div className="w-full">
            ...
            <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-2xl border-2 border-white/80 p-10 md:p-12">
              ...
              <div className="text-center mb-12">
                ...
                <h2 className="text-4xl font-black text-gray-900 mb-3">Crear Cuenta</h2>
                <p className="text-lg text-gray-600">Completa el formulario para empezar</p>
              </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                ...
                <div className="space-y-3">
                  <label htmlFor="confirmPassword" className="block text-base font-bold text-gray-800">
              ...
              <div className="relative my-10">
                ...
                <div className="relative flex justify-center text-base">
                  <span className="px-5 bg-white text-gray-500 font-medium">¿Ya tienes cuenta?</span>
                </div>
              </div>
